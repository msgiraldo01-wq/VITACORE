...
def glosas():
    ...
    lista_glosas = obtener_todas_glosas()
...
def exportar_excel():
    ...
    for col, total in enumerate(
        [total_glosado, total_aceptado, total_levantado, total_ratificado], start=5
    ):
